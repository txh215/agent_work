...
NVIDIA_API_KEY_LLAMA33="sk-YOUR_NVIDIA_API_KEY_LLAMA33 HERE"
请将 "sk-YOUR_DEEPSEEK_API_KEY_HERE" 替换为您的实际 ChatNVIDIA API Key。

运行 Agent 脚本:
创建一个主脚本文件，将以下提供的代码粘贴进去。
然后运行：
...
Thought: The user is asking about the weather in Beijing. I should use the 'Weather' tool to get this information.
Action: WeatherTool
...
掌握了使用 DeepSeek LLM 作为 Agent 驱动模型的集成方法。
